const TICKETS = [
  ["Юсуповский дворец", "https://yusupov-palace.ru/ru/programs", "yusupov-palace.ru", "4 сен"],
  ["Эрмитаж — Главный штаб (выставка)", "https://tickets.hermitagemuseum.org/", "tickets.hermitagemuseum.org", "3 сен днём"],
  ["Променад-концерт «Чудесный источник»", "https://tickets.hermitagemuseum.org/", "tickets.hermitagemuseum.org", "11 сен, опц."],
  ["Эрмитаж — Манеж Малого Эрмитажа (вход)", "https://tickets.hermitagemuseum.org/", "tickets.hermitagemuseum.org", "3 сен утро · онлайн-билет обязателен"],
  ["Русский музей", "https://ticket.rusmuseum.ru", "ticket.rusmuseum.ru", "5 сен"],
  ["Спас на Крови / Исаакий / колоннада", "https://isaak.ticketnet.ru", "isaak.ticketnet.ru", "4, 5, 6 сен"],
